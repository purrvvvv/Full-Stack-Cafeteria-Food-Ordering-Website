...
import React from 'react'
 ...
 <div className='p-4 h-screen flex items-center justify-center'>
    ...
    <div className='p-10 flex flex-col gap-6 justify-center items-center md:w-1/2'>
      <h1 className='font-bold text-xl lg:text-2xl'>Welcome</h1>
      <p className='text-centre'>Log into your account or create a new one using social buttons</p>
      <button className='flex gap-4 p-4 ring-1 ring-orange-300 rounded-md '  onClick={() => signIn("google")}>
